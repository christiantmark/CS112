 ...
 * 
 * *** You should limit yourself to the changes mentioned in Problem 9. ***
 */
...
public class BattleshipGame {
    ...
    public void initialize(Scanner console) {
        ...
        do {
            ...
            if (choice == 1) {
                ...
                this.players[0] = new HumanPlayer("you");               // change to HumanPlayer
                
                // computer player
                this.boards[1] = new HiddenShipsBoard(DIMENSION);
                this.players[1] = new ComputerPlayer("the computer");      // change to ComputerPlayer
                
                validChoice = true;
                this.shouldPause = false;                           // change to false
            } else if (choice == 2) {
                // first computer player
                this.boards[0] = new Board(DIMENSION);
                this.players[0] = new ComputerPlayer("player 0");          // change to ComputerPlayer
                
                // second computer player
                this.boards[1] = new Board(DIMENSION);
                this.players[1] = new ComputerPlayer("player 1");          // change to ComputerPlayer
    ...
    public static void addShipsTo(Player player, Board board) {
        ...
        addShipTo(new Tanker(), player, board);    // change to Tanker constructor

...
public class StringNode {
    ...
    public static StringNode copy(StringNode str) {
        ...
        StringNode travCopy = new StringNode(str.ch, null);
        StringNode head = travCopy;
        StringNode trav = str;
        while(trav.next != null) {
        	travCopy.ch = trav.ch;
        	travCopy.next = new StringNode(trav.next.ch, null);
    ...
    public static boolean isPrefix(StringNode prefix, StringNode str) {
    	StringNode trav = str;
    	boolean equal = true;
    	if(length(prefix) > length(trav))
    		return false;
    	while(trav != null && prefix != null && equal) {
    		if(trav.ch != prefix.ch) {
    			equal = false;
    		}
    		else {
	    		trav = trav.next;
